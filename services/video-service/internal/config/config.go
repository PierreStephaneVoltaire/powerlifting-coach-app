...
func Load() *Config {
	...
	return &Config{
		...
		DatabaseURL:       getEnv("DATABASE_URL", "postgres://app_user:password@localhost:5432/lazylifts_app?sslmode=disable"),
		...
		SpacesBucket:      getEnv("SPACES_BUCKET", "lazylifts-videos"),
		SpacesRegion:      getEnv("SPACES_REGION", "eastus"),
		SpacesEndpoint:    getEnv("SPACES_ENDPOINT", "https://lazyliftsdevvideos.blob.core.windows.net"),
